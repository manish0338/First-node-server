...
if [ -z "$ISPN_SERVER_CONF" ]; then
  ISPN_SERVER_CONF="home/manish/ispn01/scripts/$prog.conf"
fi
...
if [ -z "$ISPN_SERVER_HOME" ]; then
  ISPN_SERVER_HOME="home/manish/ispn01/ispn-server"
fi
...
if [ -z "$ISPN_SERVER_CONSOLE_LOG" ]; then
  ISPN_SERVER_CONSOLE_LOG="home/manish/ispn01/log/console.log"
fi
